...
class Designer extends Employee{
    public effectivnessCoefficient:number;
...
class Manager extends Employee {
    ...
    constructor(name: string, secondName: string,  experience: number, team?:(Developer|Designer)[]) {
        super(name, secondName,  experience);
        //this.team = team;
    }
    public giveSalary(salary: number): void {
...
class Departament {
    ...
    public giveSalary(name:string, secondName:string):void {
            ...
            //if (emp) emp.giveSalary(emp.salary);
